...
<template>
    <div class="p-4 bg-zinc-900/50 border border-white/5 rounded-2xl space-y-3">
        ...
        <div class="grid grid-cols-3 gap-2">
            <UButton size="xs" variant="subtle" color="gray" :disabled="isSaving" @click="updateSchedule(24)"
                class="justify-center rounded-lg">
                +24 Hours
            </UButton>
            <UButton size="xs" variant="subtle" color="gray" :disabled="isSaving" @click="updateSchedule(48)"
                class="justify-center rounded-lg">
                +48 Hours
            </UButton>
            <UButton size="xs" variant="subtle" color="red" :disabled="isSaving || props.currentStatus === 'none'"
                @click="updateSchedule(null)" class="justify-center rounded-lg">
                Opt-Out Lead
            </UButton>
        </div>
    </div>
