...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const homes = ref((_a = home.value) != null ? _a : []);
    ...
    const filteredHomes = computed(() => {
      return homes.value.filter((home2) => {
        var _a2, _b;
        const matchString = `${home2.title} ${(_a2 = home2.addressDetails) == null ? void 0 : _a2.fullAddress} ${(_b = home2.addressDetails) == null ? void 0 : _b.zipCode}`.toLowerCase();
