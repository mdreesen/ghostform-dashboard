...
import { u as useHead, v as useNuxtData, c as __nuxt_component_3$1 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex flex-wrap justify-evenly gap-18">`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
...
//# sourceMappingURL=index-sbkYhFVS.mjs.map
