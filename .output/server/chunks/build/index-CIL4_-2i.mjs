...
import { u as useHead, I as useNuxtData, c as __nuxt_component_1$1 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="flex flex-col gap-18 max-w-350 mx-auto relative z-10"><section class="flex flex-col">`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Overview" }, null, _parent));
      _push(`<div class="flex flex-wrap justify-between gap-6">`);
      if (unref(leads)?.all) {
        _push(ssrRenderComponent(_component_appCardsOverview, { leads: unref(leads) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div></section><section class="flex flex-col">`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Lead Charts" }, null, _parent));
      _push(`<div class="flex flex-wrap items-center justify-evenly gap-18">`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</div></section><section class="space-y-6 w-full">`);
...
//# sourceMappingURL=index-CIL4_-2i.mjs.map
