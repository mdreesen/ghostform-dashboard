...
import { u as useHead, K as useNuxtData, _ as __nuxt_component_0$1, q as _sfc_main$8, w as reactivePick, L as useRuntimeConfig } from './server.mjs';
import { _ as _sfc_main$4 } from './Modal-D1BiXRFq.mjs';
import { defineComponent, computed, mergeProps, unref, ref, withCtx, createTextVNode, createVNode, useAttrs, toRef, h, resolveDynamicComponent, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    const formFunnels = computed(() => [
      ...
      },
      {
        id: "data-active",
        label: "Active Entry",
        description: "To gather more defined information from the lead.",
        badge: "Active lead",
        source: "data_active",
        icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586A1 1 0 0114 3.414L18.586 8A1 1 0 0119 8.586V19a2 2 0 01-2 2z",
...
//# sourceMappingURL=index-FI9WkK_b.mjs.map
