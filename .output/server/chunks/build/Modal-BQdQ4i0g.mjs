import { _ as __nuxt_component_0$2 } from './Auth-YSaql3Au.mjs';
import { defineComponent, mergeProps, useSlots, toRef, computed, unref, withCtx, toHandlers, renderSlot, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createVNode, Fragment, ref, toRefs, withDirectives, vShow, normalizeProps, guardReactiveProps, watch, withModifiers, useSSRContext } from 'vue';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_baseHeaderAuth = __nuxt_component_0$2;
...
const __nuxt_component_0$1 = Object.assign(_sfc_main$2, { __name: "AppHeader" });
...
export { __nuxt_component_0$1 as _, __nuxt_component_0 as a, _sfc_main as b };
//# sourceMappingURL=Modal-BQdQ4i0g.mjs.map
