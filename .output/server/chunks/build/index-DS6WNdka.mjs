...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="max-w-350 mx-auto relative z-10"><section class="flex flex-col space-y-6">`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Overview" }, null, _parent));
      _push(`<div class="flex flex-wrap justify-between gap-6 mb-12">`);
      if (unref(leads)?.all) {
      ...
      _push(`</div></section>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`<section class="space-y-6 w-full">`);
...
//# sourceMappingURL=index-DS6WNdka.mjs.map
