...
import { _ as __nuxt_component_2$1 } from './Section-D5LAJ1ec.mjs';
import * as vue from 'vue';
import { defineComponent, unref, mergeProps, withCtx, createVNode, createTextVNode, useSlots, toRef, computed, toHandlers, renderSlot, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, ref, toRefs, normalizeProps, guardReactiveProps, useAttrs, h, resolveDynamicComponent, watch, reactive, watchEffect, nextTick, normalizeStyle, toValue, useSSRContext } from 'vue';
...
import { K as useNuxtData, I as _sfc_main$8, _ as __nuxt_component_0$2, y as useLocale, z as useAppConfig, B as useComponentUI, C as useForwardPropsEmits, D as reactivePick, F as usePortal, G as createReusableTemplate, H as tv, V as VisuallyHidden_default, f as useVModel, w as useEmitAsProps, h as useForwardExpose, x as Presence_default, P as Primitive, T as Teleport_default, g as createContext, i as injectConfigProviderContext, J as useRuntimeConfig, e as unrefElement, t as tryOnBeforeUnmount, l as getActiveElement, A as AUTOFOCUS_ON_MOUNT, m as focusFirst, p as getTabbableCandidates, q as focus, s as AUTOFOCUS_ON_UNMOUNT, o as onKeyStroke, j as isNullish, d as createSharedComposable, E as EVENT_OPTIONS, v as getTabbableEdges, k as createGlobalState } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_baseHeaderSection = __nuxt_component_2$1;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-1cd04985>`);
      _push(ssrRenderComponent(_component_appHeader, {
        label: "Forms",
        subLabel: "Form Selection"
      }, null, _parent));
      _push(`<div data-v-1cd04985>`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Select available forms" }, null, _parent));
      _push(`<section class="flex flex-wrap justify-between gap-6" data-v-1cd04985>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1cd04985"]]);

export { index as default };
//# sourceMappingURL=index-CN5EHpka.mjs.map
