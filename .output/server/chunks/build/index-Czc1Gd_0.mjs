import { _ as __nuxt_component_0, a as _sfc_main$7, u as useId, b as useBodyScrollLock, c as useHideOthers, F as FocusScope_default, D as DismissableLayer_default, f as focusFirst } from './Modal-BmlmObcY.mjs';
import { _ as __nuxt_component_0$1 } from './Section-DiRQyLao.mjs';
import { s as useUserSession, M as useNuxtData, v as useComponentProps, w as useAppConfig, x as useForwardProps, y as reactivePick, z as usePortal, A as useFormField, B as useFieldGroup, C as useComponentIcons, D as tv, E as isArrayOfArray, F as _sfc_main$e, G as _sfc_main$b, H as FieldGroupReset, I as get, J as _sfc_main$c, l as useVModel, P as Primitive, t as _sfc_main$8, m as isNullish, o as useCollection, K as looseToNumber, k as useForwardExpose, L as getDisplayValue, T as Teleport_default, q as Presence_default, r as refreshNuxtData, i as injectConfigProviderContext, d as unrefElement, j as createContext, V as VisuallyHidden_default, g as refAutoReset, e as useForwardProps$1, f as useEmitAsProps, h as getActiveElement, p as useResizeObserver } from './server.mjs';
import { defineComponent, ref, computed, watch, unref, withCtx, createVNode, useSlots, toRef, useTemplateRef, mergeProps, renderSlot, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, resolveDynamicComponent, nextTick, isRef, toRefs, createElementBlock, withModifiers, normalizeProps, guardReactiveProps, Teleport, toValue, createElementVNode, watchPostEffect, watchEffect, normalizeStyle, withMemo, mergeDefaults, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderVNode } from 'vue/server-renderer';
import { u as useToast } from './useToast-D5yRuci7.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$6 } from './Input-DNgNLnhr.mjs';
import { E as defu, J as isEqual } from '../nitro/nitro.mjs';
...
const __nuxt_component_3 = Object.assign(_sfc_main$5, { __name: "BaseButtonDelete" });
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_baseButtonDelete = __nuxt_component_3;
      ...
      _push(`<span class="${ssrRenderClass([unref(isActive) ? "bg-[#5A6349]/10 text-[#5A6349]" : "bg-zinc-500/10 text-[#8A847C]", "text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded-full"])}">${ssrInterpolate(unref(isActive) ? "Active" : "Paused")}</span></div><div class="flex flex-col gap-6"><div class="text-md font-bold tabular-nums"> Campaign for <span class="text-[#B5563A]">${ssrInterpolate(__props.data?.targetStatus)}</span> leads </div><div class="text-xs text-[#8A847C] -mt-4">${ssrInterpolate(unref(cadenceLabel))} · ${ssrInterpolate(unref(dayLabel))}</div><p class="text-md font-bold tabular-nums">${ssrInterpolate(__props.data?.subject)}</p><div class="flex flex-col gap-3">`);
      ...
      _push(ssrRenderComponent(_component_UModal, {
        title: `Delete ${__props.data?.title} Campaign?`,
        open: unref(open),
...
const __nuxt_component_2 = Object.assign(_sfc_main$4, { __name: "BaseCardCampaign" });
const theme$1 = {
  "slots": {
    "base": [
...
const _sfc_main$3 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const position = computed(() => props.content?.position ?? appConfig.ui?.select?.defaultVariants?.position ?? theme$1.defaultVariants?.position);
    ...
    const ui = computed(() => tv({ extend: theme$1, ...appConfig.ui?.select || {} })({
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const appConfig = useAppConfig();
    const { emitFormFocus, emitFormBlur, emitFormInput, emitFormChange, size: size2, color, id, name, highlight, disabled, ariaAttrs } = useFormField(_props, { deferInputValidation: true });
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({ class: "inline-flex items-center disabled:cursor-not-allowed aria-disabled:cursor-not-allowed disabled:opacity-75 aria-disabled:opacity-75 gap-1.5 ring ring-inset ring-accented hover:bg-accented/75 active:bg-accented/75 disabled:bg-elevated aria-disabled:bg-elevated focus:outline-none focus-visible:ring-2 focus-visible:ring-inverted bg-[#B5563A] text-[#F7F4EF] px-6 py-3 text-xs font-bold hover:shadow-[0_0_20px_rgba(48,207,67,0.4)] transition-all" }, _attrs))}>${ssrInterpolate(__props.text)}</button>`);
    };
  }
});
...
const __nuxt_component_7 = Object.assign(_sfc_main$1, { __name: "BaseButton" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_baseHeaderSection = __nuxt_component_0$1;
      const _component_baseCardCampaign = __nuxt_component_2;
      ...
      _push(ssrRenderComponent(_component_appHeader, {
        ...
        subLabel: "Manage your emails"
      }, null, _parent));
      _push(`<div class="flex flex-col gap-12"><section>`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Current Campaigns" }, null, _parent));
      _push(`<div class="flex flex-wrap gap-6"><!--[-->`);
      ssrRenderList(unref(useCampaigns), (item) => {
        _push(ssrRenderComponent(_component_baseCardCampaign, { data: item }, null, _parent));
      });
      _push(`<!--]--></div></section><section>`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Create new campaigns" }, null, _parent));
      _push(`<form class="grid md:grid-cols-3 gap-6"><div class="space-y-4 bg-[#F7F4EF]/30 border border-[#DDD6C9] p-6 h-fit">`);
      _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Recurrence Intervals" }, null, _parent));
      _push(ssrRenderComponent(_component_UFormField, { label: "Campaign Title Name" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: unref(form).title,
              "onUpdate:modelValue": ($event) => unref(form).title = $event,
              placeholder: "Monday Morning Followup",
              class: "w-full"
            }, null, _parent2, _scopeId));
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_UFormField, { label: "Target Audience Tier" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(ssrRenderComponent(_component_UFormField, { label: "Preferred Dispatch Day" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_USelect, {
      ...
      _push(ssrRenderComponent(_component_UFormField, { label: "Monthly Frequency Density" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_USelect, {
      ...
      _push(`</div><div class="md:col-span-2 space-y-5 bg-[#F7F4EF]/10 border border-[#DDD6C9] p-6">`);
      _push(ssrRenderComponent(_component_UFormField, { label: "Drip Campaign Subject Line" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UInput, {
              modelValue: unref(form).subject,
              "onUpdate:modelValue": ($event) => unref(form).subject = $event,
              placeholder: "Checking in on your property parameters...",
              class: "w-full"
            }, null, _parent2, _scopeId));
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_UFormField, { label: "Communication Script Body Text (Plain)" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`<div class="flex justify-between items-center pt-2">`);
      _push(ssrRenderComponent(_component_baseButton, {
        loading: unref(isSaving),
        text: "save & start campaign"
      }, null, _parent));
      _push(`</div></div></form></section></div></div>`);
    };
  }
});
...
//# sourceMappingURL=index-Czc1Gd_0.mjs.map
