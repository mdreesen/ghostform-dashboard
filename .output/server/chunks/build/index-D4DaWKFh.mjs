...
import { defineComponent, reactive, ref, mergeProps, withCtx, createTextVNode, unref, createVNode, openBlock, createBlock, createCommentVNode, useSlots, computed, renderSlot, toDisplayString, useId, useTemplateRef, inject, provide, readonly, resolveDynamicComponent, watch, useSSRContext } from 'vue';
...
import { d as useNuxtData, B as useUserSession, C as _sfc_main$8, _ as __nuxt_component_0$2, f as useAppConfig, g as useComponentUI, h as useFieldGroup, i as useComponentIcons, t as tv, P as Primitive, j as _sfc_main$e, k as _sfc_main$b, l as formBusInjectionKey, m as formStateInjectionKey, o as formErrorsInjectionKey, p as formInputsInjectionKey, q as formLoadingInjectionKey, s as formOptionsInjectionKey, w as inputIdInjectionKey, x as formFieldInjectionKey, y as useVModel, z as useFormField, v as useEventBus, e as useForwardExpose, A as looseToNumber } from './server.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const { emitFormBlur, emitFormInput, emitFormChange, size: formGroupSize, color, id, name: name2, highlight, disabled, emitFormFocus, ariaAttrs } = useFormField(props, {});
    const { orientation, size: fieldGroupSize } = useFieldGroup(props);
    const { isLeading, isTrailing, leadingIconName, trailingIconName } = useComponentIcons(props);
...
const dependencies = { "@nuxt/eslint": "^1.15.2", "@nuxt/image": "^1.11.0", "@nuxt/kit": "^4.2.2", "@nuxt/ui": "^4.3.0", "@nuxtjs/tailwindcss": "^6.14.0", "@pinia/nuxt": "^0.11.3", "@tailwindcss/vite": "^4.1.13", "@vite-pwa/nuxt": "^1.0.4", "@vueuse/motion": "^3.0.3", "bcrypt": "^6.0.0", "date-fns": "^4.1.0", "dexie": "^4.4.2", "lucide-vue-next": "^0.556.0", "mongodb": "^6.21.0", "mongoose": "^8.23.1", "nuxt": "^4.2.2", "nuxt-auth-utils": "^0.5.25", "nuxt-charts": "^0.2.4", "nuxt-google-auth": "^0.1.7", "nuxt-notify": "^1.1.4", "nuxt-qrcode": "^0.4.10", "nuxt-vitalizer": "^2.0.0", "pinia": "^3.0.4", "reka-ui": "^2.6.1", "resend": "^6.12.3", "stripe": "^22.1.1", "tailwindcss": "^4.1.13", "vue": "^3.5.21", "vue-router": "^4.5.1", "xlsx": "^0.18.5", "zod": "^4.4.3" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen p-4 sm:p-8" }, _attrs))}><div class="max-w-4xl mx-auto py-10 flex flex-col gap-8"><header class="pb-8 border-b border-gray-700">`);
...
//# sourceMappingURL=index-D4DaWKFh.mjs.map
