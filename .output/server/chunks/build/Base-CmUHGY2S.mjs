...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<h2${ssrRenderAttrs(mergeProps({ class: "text-4xl font-semibold mb-12 text-center" }, _attrs))}>${ssrInterpolate(__props.text)}</h2>`);
    };
  }
});
...
//# sourceMappingURL=Base-CmUHGY2S.mjs.map
