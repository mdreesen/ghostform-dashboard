...
import { u as useHead, d as useNuxtData, C as _sfc_main$8, c as __nuxt_component_5, X as useLocale, f as useAppConfig, g as useComponentUI, Y as useForwardPropsEmits, Z as reactivePick, $ as usePortal, a0 as createReusableTemplate, t as tv, a1 as VisuallyHidden_default, y as useVModel, U as useEmitAsProps, e as useForwardExpose, V as Presence_default, P as Primitive, W as Teleport_default, H as createContext, F as injectConfigProviderContext, a2 as useRuntimeConfig, G as unrefElement, D as tryOnBeforeUnmount, L as getActiveElement, M as AUTOFOCUS_ON_MOUNT, N as focusFirst, O as getTabbableCandidates, Q as focus, R as AUTOFOCUS_ON_UNMOUNT, I as onKeyStroke, J as isNullish, E as createSharedComposable, S as EVENT_OPTIONS, T as getTabbableEdges, K as createGlobalState } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-20 p-6 lg:py-18 relative overflow-hidden" }, _attrs))} data-v-52222914><div class="absolute top-0 right-0 w-150 h-150 bg-cyan-400 rounded-full blur-[200px] opacity-[0.03]" data-v-52222914></div><header class="max-w-350 mx-auto flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6 relative z-10" data-v-52222914><div data-v-52222914><div class="flex items-center gap-3 mb-2" data-v-52222914>`);
      ...
      _push(`</div><div class="flex gap-4" data-v-52222914>`);
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_baseQrCode, {
              ...
              value: unref(ghostFormUrl)(unref(user)?.category, unref(user)?.company_hashed, unref(user)?.email_hashed, unref(user)?.calendar_link)
      ...
      _push(`</div></header><main class="max-w-350 mx-auto relative z-10" data-v-52222914><section class="flex flex-wrap justify-between gap-6 mb-12" data-v-52222914>`);
      if (unref(leads)) {
        _push(`<!--[-->`);
      ...
      _push(`</section><div class="flex w-full" data-v-52222914><div class="space-y-6 w-full" data-v-52222914><div class="flex justify-between items-end mb-4" data-v-52222914>`);
      if (unref(leads)) {
        _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Lead Tracking" }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="backdrop-blur-xl bg-white/2 border border-white/8 rounded-[2.5rem] overflow-hidden w-full" data-v-52222914>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-52222914"]]);

export { index as default };
//# sourceMappingURL=index-WcbbSvjZ.mjs.map
