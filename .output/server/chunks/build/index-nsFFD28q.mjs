import { _ as __nuxt_component_0, a as _sfc_main$4 } from './Modal-BmlmObcY.mjs';
import { _ as __nuxt_component_1 } from './Navigate-i621a1mh.mjs';
import { _ as __nuxt_component_0$1 } from './Section-DiRQyLao.mjs';
import { M as useNuxtData, t as _sfc_main$8, _ as __nuxt_component_0$1$1, y as reactivePick, N as useRuntimeConfig } from './server.mjs';
import { ref, defineComponent, unref, withCtx, createVNode, createTextVNode, mergeProps, useAttrs, computed, toRef, h, resolveDynamicComponent, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="max-w-4xl mx-auto space-y-8"><header class="border-b border-[#DDD6C9]/60 pb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">`);
      ...
      ssrRenderList(formFunnels.value, (item) => {
        _push(`<div class="relative overflow-hidden bg-[#EFEAE0] border border-[#DDD6C9]/80 hover:border-[#DDD6C9]/80 p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6 transition-all duration-300 group hover:shadow-2xl">`);
...
//# sourceMappingURL=index-nsFFD28q.mjs.map
