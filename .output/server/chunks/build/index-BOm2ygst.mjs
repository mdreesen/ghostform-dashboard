import { _ as __nuxt_component_0$1, a as _sfc_main$7 } from './Modal-BDoaUPlC.mjs';
...
import { ssrRenderAttrs, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderSlot, ssrRenderVNode } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="text-[12px] text-[#A9A39A] leading-relaxed pt-1"> Emails go out in the morning on the day you pick. </p></div><div class="lg:col-span-2 space-y-6 bg-[#EFEAE0] border border-[#DDD6C9] p-7"><p class="gf-eyebrow">What it says</p>`);
...
//# sourceMappingURL=index-BOm2ygst.mjs.map
