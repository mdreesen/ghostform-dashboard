...
import { defineComponent, computed, mergeProps, unref, withCtx, createVNode, useSlots, toRef, toHandlers, renderSlot, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, ref, toRefs, normalizeProps, guardReactiveProps, useAttrs, h, resolveDynamicComponent, watch, reactive, watchEffect, nextTick, normalizeStyle, toValue, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderVNode } from 'vue/server-renderer';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { _ as __nuxt_component_1 } from './Auth-BV9RYU2X.mjs';
import { u as useHead, d as useNuxtData, v as _sfc_main$8, c as __nuxt_component_5, Q as useLocale, f as useAppConfig, g as useComponentUI, R as useForwardPropsEmits, S as reactivePick, U as usePortal, V as createReusableTemplate, t as tv, W as VisuallyHidden_default, A as useVModel, N as useEmitAsProps, e as useForwardExpose, O as Presence_default, P as Primitive, T as Teleport_default, B as createContext, y as injectConfigProviderContext, X as useRuntimeConfig, z as unrefElement, w as tryOnBeforeUnmount, F as getActiveElement, G as AUTOFOCUS_ON_MOUNT, H as focusFirst, I as getTabbableCandidates, J as focus, K as AUTOFOCUS_ON_UNMOUNT, C as onKeyStroke, D as isNullish, x as createSharedComposable, L as EVENT_OPTIONS, M as getTabbableEdges, E as createGlobalState } from './server.mjs';
...
import { _ as __nuxt_component_7 } from './Table-Cyfa8FvK.mjs';
import 'vue-router';
import '@iconify/vue';
...
import 'consola';
import 'ipx';
import './Input-D8Gp-6U2.mjs';
import '@tanstack/vue-table';
import '@tanstack/vue-virtual';
import './maps-D65SONjt.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-20 p-6 lg:py-18 relative overflow-hidden" }, _attrs))} data-v-ff3f556d><div class="absolute top-0 right-0 w-150 h-150 bg-cyan-400 rounded-full blur-[200px] opacity-[0.03]" data-v-ff3f556d></div><header class="max-w-350 mx-auto flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6 relative z-10" data-v-ff3f556d><div data-v-ff3f556d><div class="flex items-center gap-3 mb-2" data-v-ff3f556d>`);
      ...
      _push(`</div><div class="flex gap-4" data-v-ff3f556d>`);
      ...
      _push(`</div></header><main class="max-w-350 mx-auto relative z-10" data-v-ff3f556d><section class="flex flex-wrap justify-between gap-6 mb-12" data-v-ff3f556d>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</section><div class="flex w-full" data-v-ff3f556d><div class="space-y-6 w-full" data-v-ff3f556d><div class="flex justify-between items-end mb-4" data-v-ff3f556d>`);
      if (unref(leads)) {
        _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Lead Tracking" }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="backdrop-blur-xl bg-white/2 border border-white/8 rounded-[2.5rem] overflow-hidden w-full" data-v-ff3f556d>`);
      if (unref(leads)) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ff3f556d"]]);

export { index as default };
//# sourceMappingURL=index-Dja4uGPh.mjs.map
