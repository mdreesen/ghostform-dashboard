...
import { a as useRoute, b as useFetch, c as __nuxt_component_1$1$1 } from './server.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(pending_data)) {
        ...
        _push(`</div><div class="flex flex-col md:flex-row gap-6 mt-5 text-slate-200"><div class="flex flex-col">`);
        ...
        _push(ssrRenderComponent(_component_baseHeaderSection, {
          ...
          subText: unref(lead)?.best_communication_method,
          css: "mb-0"
        }, null, _parent));
...
//# sourceMappingURL=details-CbJHi-bc.mjs.map
