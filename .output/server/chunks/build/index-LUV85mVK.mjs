...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const state = reactive({
      ...
      region: (_e = data.value) == null ? void 0 : _e.region,
      calendar_link: (_f = data.value) == null ? void 0 : _f.calendar_link,
      cold_lead_after_days: (_g = data.value) == null ? void 0 : _g.cold_lead_after_days
    });
...
//# sourceMappingURL=index-LUV85mVK.mjs.map
