    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxt_link, mergeProps({ to: __props.path }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="${ssrRenderClass(`flex-1 md:flex-initial inline-flex items-center justify-center px-4 py-2 border border-[#DDD6C9] hover:border-[#A9A39A] hover:bg-slate-800/40 text-[#8A847C] hover:text-[#1F1B16] text-[11px] font-semibold uppercase tracking-wider transition-all ${__props.css}`)}"${_scopeId}>${ssrInterpolate(__props.text)}</button>`);
          } else {
            return [
              createVNode("button", {
                class: `flex-1 md:flex-initial inline-flex items-center justify-center px-4 py-2 border border-[#DDD6C9] hover:border-[#A9A39A] hover:bg-slate-800/40 text-[#8A847C] hover:text-[#1F1B16] text-[11px] font-semibold uppercase tracking-wider transition-all ${__props.css}`
...
//# sourceMappingURL=Navigate-i621a1mh.mjs.map
