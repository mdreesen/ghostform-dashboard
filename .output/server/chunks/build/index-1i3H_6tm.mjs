...
import { _ as _sfc_main$3 } from './FormField-BiYvpq54.mjs';
import { _ as _sfc_main$4 } from './Input-BtgNWAmd.mjs';
import { defineComponent, ref, watch, withCtx, unref, createVNode, useSlots, toRef, computed, useTemplateRef, mergeProps, openBlock, createBlock, renderSlot, createCommentVNode, Fragment, renderList, toDisplayString, createTextVNode, nextTick, toRefs, createElementBlock, withModifiers, normalizeProps, guardReactiveProps, Teleport, toValue, createElementVNode, watchEffect, resolveDynamicComponent, normalizeStyle, useSSRContext } from 'vue';
...
import { p as useAppConfig, q as useComponentUI, s as useForwardPropsEmits, f as reactivePick, t as usePortal, O as useFormField, Q as useFieldGroup, R as useComponentIcons, w as tv, E as isArrayOfArray, F as _sfc_main$e, G as _sfc_main$b, D as get, S as _sfc_main$c, i as useVModel, P as Primitive, M as isNullish, y as useCollection, U as looseToNumber, k as useForwardExpose, W as getDisplayValue, T as Teleport_default, m as Presence_default, L as unrefElement, j as createContext, V as VisuallyHidden_default, B as useForwardProps, x as getActiveElement, N as useResizeObserver } from './server.mjs';
import { u as useDirection, P as PopperRoot_default, d as useTypeahead, a as PopperAnchor_default, b as PopperArrow_default, c as useFocusGuards, e as PopperContent_default } from './PopperArrow-DyfCaDO9.mjs';
import { u as useId, b as useBodyScrollLock, a as useHideOthers, F as FocusScope_default, D as DismissableLayer_default, k as focusFirst } from './utils-BGAHdNAL.mjs';
import { w as defu, A as isEqual } from '../nitro/nitro.mjs';
import { _ as __nuxt_component_5 } from './button-lqMJifXL.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_baseButton = __nuxt_component_5;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_appHeader, {
        label: "Campaign Orchestrator",
        subLabel: "Manage your emails"
      }, null, _parent));
      _push(`<form class="grid md:grid-cols-3 gap-6"><div class="space-y-4 bg-zinc-900/30 border border-white/5 p-6 rounded-2xl h-fit"><h3 class="text-xs font-black uppercase tracking-wider text-[#30cf43]">Recurrence Intervals</h3>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dashboard/marketing/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-1i3H_6tm.mjs.map
