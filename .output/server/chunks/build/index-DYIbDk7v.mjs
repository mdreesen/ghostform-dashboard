...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-20 p-6 lg:py-18 relative overflow-hidden" }, _attrs))} data-v-33bb5847><div class="absolute top-0 right-0 w-150 h-150 bg-cyan-400 rounded-full blur-[200px] opacity-[0.03]" data-v-33bb5847></div><header class="max-w-350 mx-auto flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6 relative z-10" data-v-33bb5847><div data-v-33bb5847><div class="flex items-center gap-3 mb-2" data-v-33bb5847>`);
      ...
      _push(`</div><div class="flex gap-4" data-v-33bb5847>`);
      ...
      _push(`</div></header><main class="max-w-350 mx-auto relative z-10" data-v-33bb5847><section class="flex flex-wrap justify-between gap-6 mb-12" data-v-33bb5847>`);
      if (unref(leads)) {
        _push(`<!--[-->`);
      ...
      _push(`</section><div class="flex w-full" data-v-33bb5847><div class="space-y-6 w-full" data-v-33bb5847><div class="flex justify-between items-end mb-4" data-v-33bb5847>`);
      if (unref(leads)) {
        _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Lead Tracking" }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="backdrop-blur-xl bg-white/2 border border-white/8 rounded-[2.5rem] overflow-hidden w-full" data-v-33bb5847>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-33bb5847"]]);

export { index as default };
//# sourceMappingURL=index-DYIbDk7v.mjs.map
