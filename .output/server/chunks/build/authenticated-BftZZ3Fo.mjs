import { defineComponent, withAsyncContext, computed, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSlots, useModel, watch, toRef, renderSlot, createCommentVNode, mergeModels, resolveDynamicComponent, toHandlers, withKeys, ref, createElementBlock, Teleport, toRefs, watchEffect, nextTick, normalizeProps, guardReactiveProps, withModifiers, useSSRContext } from 'vue';
...
import { b as useFetch, J as useNuxtData, n as navigateTo, _ as __nuxt_component_0$2, e as __nuxt_component_1$1, ac as __nuxt_component_3$1, a as useRoute, L as useLocale, t as useAppConfig, v as useComponentUI, N as createReusableTemplate, ab as getSlotChildrenText, B as tv, d as _sfc_main$8$1, O as _sfc_main$9$1, P as Primitive, o as useForwardPropsEmits, w as reactivePick, C as isArrayOfArray, E as _sfc_main$b, G as _sfc_main$c, D as _sfc_main$e, F as get, Q as pickLinkProps, R as _sfc_main$a$1, x as usePortal, V as VisuallyHidden_default, l as useForwardExpose, h as useCollection, a6 as refAutoReset, a9 as injectTooltipProviderContext, M as reactiveOmit, a8 as isClient, p as Presence_default, g as useVModel, a5 as useEventListener, m as useResizeObserver, j as createContext, q as getActiveElement, f as unrefElement, aa as useTimeoutFn, T as Teleport_default, a7 as useDebounceFn, k as useForwardProps, i as isNullish } from './server.mjs';
import { y as defu, D as isEqual } from '../nitro/nitro.mjs';
import { _ as _sfc_main$a, D as DialogRoot_default, a as DialogTrigger_default, b as DialogPortal_default, c as DialogOverlay_default, d as DialogContent_default, e as DialogTitle_default, f as DialogDescription_default, g as DialogClose_default } from './Modal-CBaiWbYY.mjs';
import { p as pointerDownOutside } from './overlay-CjyBzL1C.mjs';
import { _ as _sfc_main$9 } from './Drawer-C9zTQK3V.mjs';
import { u as useDirection, P as PopperRoot_default, b as PopperAnchor_default, c as PopperArrow_default, e as PopperContent_default } from './PopperArrow-DwLFqynP.mjs';
import { H as HoverCard, P as Popover, _ as _sfc_main$f, u as useArrowNavigation, d as useGraceArea } from './Kbd-B9RCMXxh.mjs';
import { u as useId, D as DismissableLayer_default } from './utils-BdoY2z9M.mjs';
import { _ as _sfc_main$d } from './Badge-BrjXz4Ri.mjs';
import { _ as __nuxt_component_0$1 } from './Base-nVsy7JGX.mjs';
import { _ as __nuxt_component_1$2 } from './Navigate-DXoGGEaX.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$3), ...appConfig.ui?.header || {} })());
    const Menu = computed(() => ({
                              ...
                              if (_push5) {
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$5, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ...
                                    _: 2
                                  }, 1040, ["ui"])) : __props.orientation === "vertical" && __props.collapsed && (!!props.tooltip || !!item.tooltip) || __props.orientation === "horizontal" && !!item.tooltip ? (openBlock(), createBlock(_sfc_main$4, mergeProps({
                                    key: 1,
                                    text: unref(get)(item, props.labelKey)
                                  }, { ...tooltipProps.value, ...typeof item.tooltip === "boolean" ? {} : item.tooltip || {} }), {
                                    default: withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UHeader, mergeProps({
        mode: "slideover",
        class: "border-none fixed w-full bg-transparent"
      }, _attrs), {
                ...
                default: withCtx(() => [
                  createVNode(_component_NuxtLink, {
                    ...
                    default: withCtx(() => [
                      ...
                      createVNode("span", { class: "text-xl font-black tracking-tighter" }, "GhostForm")
                    ]),
                    _: 1
                  })
                ]),
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(unref(items), (link) => {
              _push2(ssrRenderComponent(_component_NuxtLink, {
                to: link.to,
                class: "group relative w-full flex items-center justify-end gap-1.5 font-medium text-sm before:absolute before:z-[-1] before:rounded-md focus:outline-none focus-visible:outline-none dark:focus-visible:outline-none focus-visible:before:ring-inset focus-visible:before:ring-2 focus-visible:before:ring-inverted px-2.5 py-1.5 before:inset-x-px before:inset-y-0 text-highlighted before:bg-elevated"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
            ...
            return [
              createVNode("div", { class: "flex flex-col gap-2" }, [
                (openBlock(true), createBlock(Fragment, null, renderList(unref(items), (link) => {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_baseButtonNavigate = __nuxt_component_1$2;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "bg-[#080B11] text-slate-100 selection:bg-cyan-500/30 font-sans min-h-screen relative overflow-hidden" }, _attrs))}><div class="fixed inset-0 pointer-events-none"><div class="absolute top-0 right-0 w-150 h-150 bg-cyan-400 rounded-full blur-[200px] opacity-[0.03]"></div><div class="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-cyan-500/10 blur-[120px] rounded-full"></div><div class="absolute bottom-[10%] right-[-10%] w-[40%] h-[40%] bg-purple-600/10 blur-[120px] rounded-full"></div></div>`);
      if (unref(authenticated)) {
        _push(`<!--[-->`);
        _push(ssrRenderComponent(_component_baseNavBar, null, null, _parent));
        _push(`<main class="py-20 p-6 lg:py-18">`);
...
//# sourceMappingURL=authenticated-BftZZ3Fo.mjs.map
