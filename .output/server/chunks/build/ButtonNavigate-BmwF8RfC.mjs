    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxt_link, mergeProps({ to: __props.path }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="bg-cyan-500 hover:bg-cyan-700 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900&#39;} w-full rounded-xl py-3 px-2 text-lg font-semibold text-white shadow-lg transition-all duration-300 ease-in-out"${_scopeId}>${ssrInterpolate(__props.text)}</button>`);
          } else {
            return [
              createVNode("button", { class: "bg-cyan-500 hover:bg-cyan-700 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900'} w-full rounded-xl py-3 px-2 text-lg font-semibold text-white shadow-lg transition-all duration-300 ease-in-out" }, toDisplayString(__props.text), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=ButtonNavigate-BmwF8RfC.mjs.map
