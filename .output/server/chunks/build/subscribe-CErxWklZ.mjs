    ...
    const tiers = [
      {
        ...
        stripe: `https://buy.stripe.com/8x2aEZe6D6j40B3cCn3wQ02?client_reference_id=${(_a = user == null ? void 0 : user.value) == null ? void 0 : _a._id}`,
        highlighted: true
      },
      {
        name: "Phantom",
        ...
        cta: "Start free trial",
        stripe: `https://buy.stripe.com/aFaeVffaHcHs1F759V3wQ03?client_reference_id=${(_b = user == null ? void 0 : user.value) == null ? void 0 : _b._id}`,
        highlighted: false
      }
    ];
