import { defineComponent, computed, useTemplateRef, ref, mergeProps, unref, isRef, withCtx, createVNode, createTextVNode, toDisplayString, useSlots, renderSlot, openBlock, createBlock, createCommentVNode, useModel, toRef, watch, Fragment, renderList, mergeModels, h, toRefs, normalizeProps, guardReactiveProps, useSSRContext } from 'vue';
...
import { _ as __nuxt_component_0$2, h as useVModel, C as useAppConfig, D as useComponentUI, R as useFormField, M as useFieldGroup, N as useComponentIcons, J as tv, P as Primitive, O as _sfc_main$e, Q as _sfc_main$b, B as useLocale, U as createRef, I as createReusableTemplate, W as useForwardProps, G as reactivePick, F as useForwardPropsEmits, K as _sfc_main$8, k as useForwardExpose, S as looseToNumber, j as createContext } from './server.mjs';
import { S as upperFirst, x as defu } from '../nitro/nitro.mjs';
import { getPaginationRowModel, useVueTable, getExpandedRowModel, getSortedRowModel, getFilteredRowModel, getCoreRowModel, FlexRender } from '@tanstack/vue-table';
import { useVirtualizer } from '@tanstack/vue-virtual';
import { a as __nuxt_component_5, _ as __nuxt_component_4 } from './maps-D65SONjt.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_baseMessage = __nuxt_component_4;
      const _component_baseMaps = __nuxt_component_5;
      ...
      _push(ssrRenderComponent(_component_UTable, {
        ...
        "email-cell": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_baseMessage, {
              ...
              message_type: "mailto",
              communication_type: row.original?.email
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_baseMessage, {
                ...
                message_type: "mailto",
                communication_type: row.original?.email
              }, null, 8, ["label", "communication_type"])
            ];
          }
        }),
        "phone-cell": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_baseMessage, {
              label: row.original?.phone,
              message_type: "sms",
              communication_type: row.original?.phone
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_baseMessage, {
        ...
        "address-cell": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_baseMaps, {
              address: row.original?.address
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_baseMaps, {
                address: row.original?.address
              }, null, 8, ["address"])
            ];
          }
...
const __nuxt_component_7 = Object.assign(_sfc_main, { __name: "BaseTable" });

export { __nuxt_component_7 as _ };
//# sourceMappingURL=Table-BYZBP0tO.mjs.map
