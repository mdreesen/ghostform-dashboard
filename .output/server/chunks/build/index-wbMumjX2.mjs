...
import { K as useNuxtData, p as useUserSession, q as _sfc_main$8, _ as __nuxt_component_0$1, s as useComponentProps, t as useAppConfig, z as useFieldGroup, A as useComponentIcons, B as tv, P as Primitive, D as _sfc_main$e, E as _sfc_main$b, a9 as formBusInjectionKey, aa as formStateInjectionKey, ab as formErrorsInjectionKey, ac as formInputsInjectionKey, ad as formLoadingInjectionKey, ae as formOptionsInjectionKey, af as useEventBus } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="flex flex-col gap-8 mt-10 pt-8 border-t border-gray-700"><button class="px-6 py-3 bg-red-600 rounded-lg font-semibold hover:bg-red-700 transition duration-300"> Sign Out </button><div class="mb-10 pb-10 border-b border-[#DDD6C9]"><p class="gf-eyebrow mb-3">Getting started</p><p class="text-[14px] text-[#8A847C] leading-relaxed mb-5 max-w-[52ch]"> Run the two-minute walkthrough again if you want a refresher on where everything lives. </p><button class="px-6 py-3.5 border border-[#DDD6C9] text-[#8A847C] text-[11px] uppercase tracking-[0.12em] font-semibold hover:border-[#1F1B16] hover:text-[#1F1B16] transition-colors"> Replay the tour </button></div>`);
...
//# sourceMappingURL=index-wbMumjX2.mjs.map
