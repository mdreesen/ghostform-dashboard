import { b as useFetch, I as useNuxtData, n as navigateTo, _ as __nuxt_component_0$2, al as __nuxt_component_1$1 } from './server.mjs';
import { defineComponent, withAsyncContext, computed, mergeProps, unref, ref, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext } from 'vue';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const navLinks = [
      ...
      { name: "Campaigns", href: "/dashboard/campaigns", target: "" },
...
//# sourceMappingURL=authenticated-bB9aMJpw.mjs.map
