import { useSlots, computed, inject, ref, useId, watch, provide, unref, mergeProps, withCtx, renderSlot, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, useTemplateRef, defineComponent, useSSRContext } from 'vue';
...
import { v as useComponentProps, w as useAppConfig, D as tv, a5 as formErrorsInjectionKey, a6 as formInputsInjectionKey, aa as inputIdInjectionKey, ab as formFieldInjectionKey, P as Primitive, l as useVModel, A as useFormField, B as useFieldGroup, C as useComponentIcons, F as _sfc_main$e, G as _sfc_main$b, k as useForwardExpose, K as looseToNumber } from './server.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: theme$1, ...appConfig.ui?.formField || {} })({
      size: props.size,
...
//# sourceMappingURL=Input-DNgNLnhr.mjs.map
