import { a as defineEventHandler, e as setHeader, v as readQualifyToken, b as createError, c as connectDB, s as schemaImport, w as questionsFor } from '../../../nitro/nitro.mjs';
import 'mongoose';
import 'node:crypto';
import 'openai';
import 'resend';
