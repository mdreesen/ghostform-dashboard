...
import { getContext, executeAsync } from "/Users/mdreesen/projects/ghostform-dashboard/node_modules/nuxt/node_modules/unctx/dist/index.mjs";
...
const __nuxt_page_meta$2 = { layout: "authenticated" };
...
const _routes = [
  ...
  },
  {
    ...
    path: "/login",
    meta: { "groups": ["authentication"] },
    component: () => import("./_nuxt/login-CIADrefe.js")
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import("./_nuxt/privacy-policy-Bu-PXzVj.js")
  },
  {
    name: "signup",
    path: "/signup",
  ...
  },
  {
    ...
    component: () => import("./_nuxt/subscribe-CurHBC2f.js")
  },
  {
  ...
  },
  {
    ...
    path: "/",
    meta: { "groups": ["authentication"] },
    component: () => import("./_nuxt/index-CSU_rkkw.js")
  }
];
...
const auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to) => {
  ...
  try {
    const me = ([__temp, __restore] = executeAsync$1(() => requestFetch("/api/user")), __temp = await __temp, __restore(), __temp);
...
const session_server_fi7D7q_WjeXZl2Hh05GOWPuIxZQWSnpY3ifY_sSGHJo = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    if (nuxtApp.payload.serverRendered && !nuxtApp.payload.prerenderedAt && !nuxtApp.payload.isCached && nuxtApp.$config.public.auth.loadStrategy !== "client-only") {
      [__temp, __restore] = executeAsync$1(() => useUserSession().fetch()), await __temp, __restore();
    }
  }
});
...
const layouts = {
  authenticated: defineAsyncComponent(() => import("./_nuxt/authenticated-TvldbVpF.js").then((m) => m.default || m)),
...
export {
  ...
  useForwardProps$1 as j,
  useForwardExpose as k,
  useResizeObserver as l,
  Presence_default as m,
  navigateTo as n,
  getActiveElement as o,
  useUserSession as p,
  _sfc_main$8 as q,
  refreshNuxtData as r,
  useComponentProps as s,
  useAppConfig as t,
  useHead as u,
  useForwardProps as v,
  reactivePick as w,
  usePortal as x,
  useFormField as y,
  useFieldGroup as z
