import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef as toRef$1, shallowRef, isReadonly, isRef, computed, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, createElementBlock, provide, cloneVNode, h, toValue, onServerPrefetch, ref, nextTick, unref, onScopeDispose, resolveComponent, watch, useSlots, Fragment, toRefs, renderSlot, shallowReadonly, readonly, customRef, toHandlerKey, camelize as camelize$1, Comment, mergeProps, openBlock, createBlock, withCtx, Teleport, createCommentVNode, watchEffect, markRaw, createTextVNode, toDisplayString, createVNode, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, resolveDynamicComponent, useSSRContext, useAttrs, useModel, mergeModels, renderList, useTemplateRef, useId, Suspense, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import defu$1, { defu, defuFn } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash, withLeadingSlash, encodeParam } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/ufo/dist/index.mjs";
import { appendResponseHeader, appendHeader } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/h3/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader, getIcon, loadIcon as loadIcon$1, Icon } from "@iconify/vue";
import { klona } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/klona/dist/index.mjs";
import { debounce } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import colors from "tailwindcss/colors";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1 } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/@unhead/vue/dist/index.mjs";
...
import { ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderSuspense } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/details-D0nsZsao.js")
  },
  {
    name: "dashboard-leads-id-edit",
    path: "/dashboard/leads/:id()/edit",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/edit-DzJ2daxt.js")
  },
  {
    name: "dashboard-form",
    path: "/dashboard/form",
    meta: __nuxt_page_meta$4 || {},
    component: () => import("./_nuxt/index-CLfPATai.js")
  },
  {
    name: "dashboard-leads",
    path: "/dashboard/leads",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/index-CX8QAs_O.js")
  },
  {
    name: "dashboard-profile",
    path: "/dashboard/profile",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/index-CPUOZyps.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/index-BeZroxVe.js")
  },
  {
    name: "forgotpassword",
    path: "/forgotpassword",
    meta: { "groups": ["authentication"] },
    component: () => import("./_nuxt/forgotpassword-BfPLZoVy.js")
  },
  {
    name: "login",
    path: "/login",
    meta: { "groups": ["authentication"] },
    component: () => import("./_nuxt/login-XTAb6kmj.js")
  },
  {
    name: "signup",
    path: "/signup",
    meta: { "groups": ["authentication"] },
    component: () => import("./_nuxt/signup-cVI32MeO.js")
  },
  {
    name: "subscribe",
    path: "/subscribe",
    meta: { ...__nuxt_page_meta || {}, ...{ "groups": ["payment"] } },
    component: () => import("./_nuxt/subscribe-DumvbsxZ.js")
  },
  {
    name: "id-resetpassword",
    path: "/:id()/resetpassword",
    meta: { "groups": ["authentication"] },
    component: () => import("./_nuxt/resetpassword-CYo86FuL.js")
  },
  {
    name: "index",
    path: "/",
    meta: { "groups": ["authentication"] },
    component: () => import("./_nuxt/index-Cyt6YUW_.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-Do_x1-RL.js")
};
...
const LazyToastContainer = defineAsyncComponent(() => import("./_nuxt/ToastContainer-Bkr-xIoD.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  authenticated: defineAsyncComponent(() => import("./_nuxt/authenticated-1OHOrpv4.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-euCfg4bU.js").then((m) => m.default || m)),
  form: defineAsyncComponent(() => import("./_nuxt/form-ChLjqg4G.js").then((m) => m.default || m)),
  payment: defineAsyncComponent(() => import("./_nuxt/payment-BRRUJSNt.js").then((m) => m.default || m))
};
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    useSeoMeta({
      ...
      // Create a 1200x630 image of your new logo
      ...
      themeColor: "#020203"
      // Matches your deep black background
    });
    return (_ctx, _push, _parent, _attrs) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B7aRPTeR.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BQWsDgh2.js"));
...
export {
  __nuxt_component_1$1 as $,
  AUTOFOCUS_ON_MOUNT as A,
  useLocale as B,
  useAppConfig as C,
  useComponentUI as D,
  EVENT_OPTIONS as E,
  useForwardPropsEmits as F,
  reactivePick as G,
  usePortal as H,
  ...
  useForwardProps as W,
  useMotion as X,
  defineNuxtRouteMiddleware as Y,
  __nuxt_component_0$1 as Z,
  __nuxt_component_0$2 as _,
  useRoute as a,
  useFetch as b,
  __nuxt_component_3$1 as c,
  useNuxtData as d,
  entry_default as default,
  useUserSession as e,
  createSharedComposable as f,
  unrefElement as g,
  useVModel as h,
  injectConfigProviderContext as i,
  createContext as j,
  useForwardExpose as k,
  isNullish as l,
  createGlobalState as m,
  navigateTo as n,
  onKeyStroke as o,
  getActiveElement as p,
  focusFirst as q,
  refreshNuxtData as r,
  getTabbableCandidates as s,
  tryOnBeforeUnmount as t,
  useHead as u,
  focus as v,
  AUTOFOCUS_ON_UNMOUNT as w,
  getTabbableEdges as x,
  useEmitAsProps as y,
  Presence_default as z
};
