import { defineComponent, openBlock, createBlock, unref, mergeProps, withCtx, renderSlot, createTextVNode, toRefs, computed, normalizeProps, guardReactiveProps, toDisplayString, useSlots, createCommentVNode, useSSRContext, useTemplateRef, createVNode, useModel, toRef, watch, Fragment, renderList, mergeModels, ref, isRef, h } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderAttrs, ssrRenderAttr, ssrRenderStyle, ssrRenderList } from "vue/server-renderer";
import { k as useForwardExpose, P as Primitive, h as useVModel, j as createContext, C as useAppConfig, D as useComponentUI, M as useFieldGroup, N as useComponentIcons, J as tv, O as _sfc_main$5, Q as _sfc_main$6, R as useFormField, S as looseToNumber, B as useLocale, U as createRef, I as createReusableTemplate, W as useForwardProps, G as reactivePick, F as useForwardPropsEmits, K as _sfc_main$7, _ as __nuxt_component_0 } from "../server.mjs";
import { upperFirst } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/scule/dist/index.mjs";
import { defu } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/defu/dist/defu.mjs";
import { useVueTable, getExpandedRowModel, getSortedRowModel, getFilteredRowModel, getCoreRowModel, FlexRender, getPaginationRowModel } from "@tanstack/vue-table";
...
const __nuxt_component_6 = Object.assign(_sfc_main, { __name: "BaseTable" });
export {
  __nuxt_component_6 as _
};
//# sourceMappingURL=Table-CmHAbaK9.js.map
