import { _ as __nuxt_component_1$1 } from "./Navigate-B_PGVHvu.js";
import { o as getActiveElement, e as useVModel, g as useCollection, P as Primitive, h as createContext, M as createSharedComposable, k as useForwardExpose, m as Presence_default, N as reactiveOmit, j as useForwardProps, T as Teleport_default, O as useEmitAsProps, Q as usePrimitiveElement, G as get, s as useComponentProps, t as useAppConfig, B as tv, R as useLocale, x as usePortal, S as createReusableTemplate, C as isArrayOfArray, D as _sfc_main$5, E as _sfc_main$6, F as FieldGroupReset, U as _sfc_main$8, W as pickLinkProps, X as _sfc_main$9, Y as omit, v as useForwardProps$1, w as reactivePick, q as _sfc_main$a, u as useHead, K as useNuxtData, c as __nuxt_component_1$2 } from "../server.mjs";
import { ref, computed, nextTick, unref, defineComponent, toRefs, openBlock, createBlock, withCtx, createVNode, renderSlot, normalizeProps, guardReactiveProps, watch, mergeDefaults, mergeProps, withModifiers, watchEffect, isRef, watchSyncEffect, withKeys, reactive, createTextVNode, toDisplayString, useSSRContext, useSlots, toRef, createCommentVNode, Fragment, renderList, resolveDynamicComponent, createSlots, useModel, mergeModels } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderVNode, ssrRenderAttrs, ssrRenderStyle } from "vue/server-renderer";
import { defu } from "/Users/mdreesen/projects/ghostform-dashboard/node_modules/defu/dist/defu.mjs";
import { u as useDirection, f as PopperAnchor_default, d as PopperArrow_default, P as PopperRoot_default, b as useFocusGuards, c as useTypeahead, a as PopperContent_default, g as PopperContentPropsDefaultValue, e as useForwardPropsEmits } from "./PopperArrow-2PR2JttJ.js";
import { u as useBodyScrollLock, F as FocusScope_default, D as DismissableLayer_default, g as getOpenState, i as isPointerInGraceArea, c as isMouseEvent, d as FIRST_LAST_KEYS, L as LAST_KEYS, f as focusFirst$1, S as SELECTION_KEYS, I as ITEM_SELECT, e as isIndeterminate, h as getCheckedState, a as useHideOthers, b as useId, j as SUB_CLOSE_KEYS, k as SUB_OPEN_KEYS } from "./utils-CybiXrU-.js";
import { _ as _sfc_main$7 } from "./Input-IhBouGrW.js";
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.loading ? (openBlock(), createBlock(_sfc_main$5, {
                    ...
                    "data-slot": "itemLeadingIcon",
                    class: __props.ui.itemLeadingIcon({ class: [__props.uiOverride?.itemLeadingIcon, item.ui?.itemLeadingIcon], color: item?.color, active })
                  }, null, 8, ["name", "class"])) : item.avatar ? (openBlock(), createBlock(_sfc_main$6, mergeProps({
                    key: 2,
                    size: item.ui?.itemLeadingAvatarSize || __props.uiOverride?.itemLeadingAvatarSize || __props.ui.itemLeadingAvatarSize()
                  }, item.avatar, {
                    "data-slot": "itemLeadingAvatar",
                                ...
                                if (_push5) {
                                  ...
                                  ssrRenderList(group, (item, index) => {
                                    ...
                                    if (item.type === "label") {
                                      ...
                                      _push5(ssrRenderComponent(_sfc_main$8, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                          ...
                                          if (_push6) {
                                            _push6(ssrRenderComponent(unref(DropdownMenu).Item, {
                                              ...
                                              default: withCtx((_5, _push7, _parent7, _scopeId6) => {
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$9, mergeProps({ ref_for: true }, slotProps, {
                                                    "data-slot": "item",
                                    ...
                                    (openBlock(true), createBlock(Fragment, null, renderList(group, (item, index) => {
                                      return openBlock(), createBlock(Fragment, {
                                        ...
                                        item.type === "label" ? (openBlock(), createBlock(unref(DropdownMenu).Label, {
                                          ...
                                          _: 2
                                        }, 1032, ["model-value", "disabled", "text-value", "class", "onUpdate:modelValue", "onSelect"])) : (openBlock(), createBlock(_sfc_main$8, mergeProps({
                                          key: 4,
                                          ref_for: true
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const appConfig = useAppConfig();
    const rootProps = useForwardProps$1(reactivePick(props, "defaultOpen", "open", "modal"), emits);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="inline-flex items-center overflow-hidden bg-[#F7F4EF] border border-[#DDD6C9]">`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</p></div><div class="gf-rise shrink-0 flex gap-2" style="${ssrRenderStyle({ "--d": ".28s" })}">`);
...
//# sourceMappingURL=index-DyAFeZGc.js.map
