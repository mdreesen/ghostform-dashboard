import { u as useHead, K as useNuxtData, p as useUserSession, b as useFetch, _ as __nuxt_component_0, c as __nuxt_component_1, q as _sfc_main$2, r as refreshNuxtData } from "../server.mjs";
import { _ as _sfc_main$1 } from "./Modal-D1BiXRFq.js";
import { _ as __nuxt_component_4 } from "./Delete-DO58WZdX.js";
import { defineComponent, ref, withAsyncContext, computed, mergeProps, unref, withCtx, createTextVNode, isRef, createVNode, useSSRContext } from "vue";
        ...
        ssrRenderList(unref(queue).approved, (post) => {
          ...
          _push(ssrRenderComponent(_component_UModal, {
            ...
            body: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="pb-6"${_scopeId}>Are you sure?</div>`);
                _push2(ssrRenderComponent(_component_baseButtonDelete, {
                  label: "Delete",
                  onClick: ($event) => useDelete(post)
                }, null, _parent2, _scopeId));
              } else {
                return [
                  createVNode("div", { class: "pb-6" }, "Are you sure?"),
...
//# sourceMappingURL=index-PX3y6Kms.js.map
