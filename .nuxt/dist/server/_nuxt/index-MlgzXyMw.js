import { _ as __nuxt_component_0$1, a as _sfc_main$6 } from "./Modal-BDoaUPlC.js";
import { d as unrefElement, i as injectConfigProviderContext, e as useVModel, f as isNullish, g as useCollection, h as createContext, V as VisuallyHidden_default, j as useForwardProps, k as useForwardExpose, l as useResizeObserver, P as Primitive, m as Presence_default, o as getActiveElement, T as Teleport_default, p as useUserSession, q as _sfc_main$5, r as refreshNuxtData, s as useComponentProps, t as useAppConfig, v as useForwardProps$1, w as reactivePick, x as usePortal, y as useFormField, z as useFieldGroup, A as useComponentIcons, B as tv, C as isArrayOfArray, D as _sfc_main$7, E as _sfc_main$8, F as FieldGroupReset, G as get, H as _sfc_main$9, I as looseToNumber, J as getDisplayValue, u as useHead, K as useNuxtData } from "../server.mjs";
import { computed, toValue, ref, defineComponent, toRefs, openBlock, createBlock, unref, withCtx, renderSlot, createElementBlock, createCommentVNode, Fragment, renderList, mergeProps, watch, createElementVNode, watchEffect, createVNode, withModifiers, resolveDynamicComponent, normalizeStyle, normalizeProps, guardReactiveProps, Teleport, nextTick, createTextVNode, toDisplayString, useSSRContext, isRef, useSlots, toRef, useTemplateRef } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderSlot, ssrRenderList, ssrRenderVNode, ssrRenderStyle, ssrLooseContain } from "vue/server-renderer";
import { u as useToast } from "./useToast-LG3isBA-.js";
import { _ as _sfc_main$a } from "./FormField-M2_i1t_0.js";
import { _ as _sfc_main$b } from "./Input-CscOUpww.js";
import { u as useDirection, P as PopperRoot_default, a as PopperContent_default, b as useFocusGuards, c as useTypeahead, d as PopperArrow_default, e as useForwardPropsEmits, f as PopperAnchor_default } from "./PopperArrow-DeVkHboT.js";
import { isEqual } from "/Users/mdreesen/projects/ghostform-dashboard/node_modules/ohash/dist/index.mjs";
import { u as useBodyScrollLock, a as useHideOthers, F as FocusScope_default, D as DismissableLayer_default, f as focusFirst, b as useId } from "./utils-y1felsNN.js";
import { defu } from "/Users/mdreesen/projects/ghostform-dashboard/node_modules/defu/dist/defu.mjs";
import { a as selection_campaign_status_lead, b as selection_days, c as selection_frequencies } from "./selections-BJNl4IgR.js";
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const rootProps = useForwardProps$1(reactivePick(props, "open", "defaultOpen", "disabled", "autocomplete", "required", "multiple", "nullableValue"), emits);
                                                      ...
                                                      ssrRenderSlot(_ctx.$slots, "item", {
                                                        ...
                                                        ssrRenderSlot(_ctx.$slots, "item-leading", {
                                                          ...
                                                          if (isSelectItem(item) && item.icon) {
                                                            ...
                                                            _push8(ssrRenderComponent(_sfc_main$8, mergeProps({
                                                        ...
                                                        _push8(ssrRenderComponent(unref(SelectItemIndicator_default), { "as-child": "" }, {
                                                          default: withCtx((_7, _push9, _parent9, _scopeId8) => {
                                                            if (_push9) {
                                                              _push9(ssrRenderComponent(_sfc_main$7, {
                                                      ...
                                                      return [
                                                        renderSlot(_ctx.$slots, "item", {
                                                          ...
                                                          renderSlot(_ctx.$slots, "item-leading", {
                                                            ...
                                                            isSelectItem(item) && item.icon ? (openBlock(), createBlock(_sfc_main$7, {
                                                              key: 0,
                                                              name: item.icon,
                                                              "data-slot": "itemLeadingIcon",
                                                              class: ui.value.itemLeadingIcon({ class: [unref(props).ui?.itemLeadingIcon, item.ui?.itemLeadingIcon] })
                                                              ...
                                                              "data-slot": "itemLeadingAvatar",
                                                              class: ui.value.itemLeadingAvatar({ class: [unref(props).ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar] })
                                                            }), null, 16, ["size", "class"])) : isSelectItem(item) && item.chip ? (openBlock(), createBlock(_sfc_main$9, mergeProps({
                                                              key: 2,
                                                              size: item.ui?.itemLeadingChipSize || unref(props).ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                                              inset: "",
                                                              standalone: ""
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const activeCount = computed(
      () => useCampaigns.value.filter((c) => c?.active !== false).length
    );
    const form = ref({
      title: "",
...
//# sourceMappingURL=index-MlgzXyMw.js.map
