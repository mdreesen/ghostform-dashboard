...
import { computed, ref, watch, defineComponent, toRefs, renderSlot, unref, openBlock, createBlock, mergeProps, withCtx, watchEffect, toValue, normalizeStyle, reactive, nextTick, createVNode, createCommentVNode, normalizeProps, guardReactiveProps, useSSRContext, useSlots, toRef, toHandlers, createTextVNode, toDisplayString, Fragment, useAttrs, h, resolveDynamicComponent } from "vue";
...
import { _ as __nuxt_component_1 } from "./Auth-BV9RYU2X.js";
import { t as tryOnBeforeUnmount, f as createSharedComposable, i as injectConfigProviderContext, g as unrefElement, h as useVModel, j as createContext, k as useForwardExpose, P as Primitive, o as onKeyStroke, l as isNullish, m as createGlobalState, p as getActiveElement, A as AUTOFOCUS_ON_MOUNT, q as focusFirst, s as getTabbableCandidates, v as focus, w as AUTOFOCUS_ON_UNMOUNT, E as EVENT_OPTIONS, x as getTabbableEdges, y as useEmitAsProps, z as Presence_default, T as Teleport_default, B as useLocale, C as useAppConfig, D as useComponentUI, F as useForwardPropsEmits, G as reactivePick, H as usePortal, I as createReusableTemplate, J as tv, V as VisuallyHidden_default, K as _sfc_main$5, L as useRuntimeConfig, u as useHead, d as useNuxtData } from "../server.mjs";
import { hideOthers } from "aria-hidden";
import { defu } from "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/defu/dist/defu.mjs";
import { p as pointerDownOutside } from "./overlay-CjyBzL1C.js";
import { encode } from "uqr";
import { _ as __nuxt_component_5 } from "./Section-B46_LQt-.js";
import { _ as __nuxt_component_6 } from "./Table-CmHAbaK9.js";
...
import "ohash/utils";
import "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/scule/dist/index.mjs";
                                    ...
                                    if (_push5) {
                                      ...
                                      return [
                                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                                          props.close ? (openBlock(), createBlock(_sfc_main$5, mergeProps({
                                            key: 0,
                                            icon: __props.closeIcon || unref(appConfig).ui.icons.close,
                                            color: "neutral",
                                            variant: "ghost",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen py-20 p-6 lg:py-18 relative overflow-hidden" }, _attrs))} data-v-234be1e4><div class="absolute top-0 right-0 w-150 h-150 bg-cyan-400 rounded-full blur-[200px] opacity-[0.03]" data-v-234be1e4></div><header class="max-w-350 mx-auto flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6 relative z-10" data-v-234be1e4><div data-v-234be1e4><div class="flex items-center gap-3 mb-2" data-v-234be1e4>`);
      ...
      _push(`</div><div class="backdrop-blur-xl bg-white/2 border border-white/8 rounded-[2.5rem] overflow-hidden w-full" data-v-234be1e4>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-234be1e4"]]);
export {
  index as default
};
//# sourceMappingURL=index-BeZroxVe.js.map
