import { defineComponent, useSSRContext, useSlots, computed, unref, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, useId, useTemplateRef, inject, provide, ref, reactive, readonly, createVNode, resolveDynamicComponent, createTextVNode } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderVNode, ssrRenderAttrs, ssrRenderTeleport, ssrRenderStyle, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from "vue/server-renderer";
import { s as useComponentProps, t as useAppConfig, z as useFieldGroup, A as useComponentIcons, B as tv, P as Primitive, D as _sfc_main$5, E as _sfc_main$6, $ as formBusInjectionKey, a0 as formStateInjectionKey, a1 as formErrorsInjectionKey, a2 as formInputsInjectionKey, a3 as formLoadingInjectionKey, a4 as formOptionsInjectionKey, a5 as useEventBus, p as useUserSession, K as useNuxtData, a as useToast, q as _sfc_main$7, c as __nuxt_component_1, _ as __nuxt_component_0$1 } from "../server.mjs";
import { _ as _sfc_main$8 } from "./FormField-Df5tB-4c.js";
import { _ as _sfc_main$9 } from "./Input-IhBouGrW.js";
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$5, {
                  ...
                  "data-slot": "leadingIcon",
                  class: ui.value.leadingIcon({ class: unref(props).ui?.leadingIcon })
                }, null, 8, ["name", "class"])) : !!unref(props).avatar ? (openBlock(), createBlock(_sfc_main$6, mergeProps({
                  key: 1,
                  size: unref(props).ui?.leadingAvatarSize || ui.value.leadingAvatarSize()
                }, unref(props).avatar, {
                  "data-slot": "leadingAvatar",
...
const dependencies = { "@aws-sdk/client-s3": "^3.1123.0", "@aws-sdk/s3-request-presigner": "^3.1123.0", "@nuxt/eslint": "^1.15.2", "@nuxt/image": "^1.11.0", "@nuxt/kit": "^4.2.2", "@nuxt/ui": "^4.3.0", "@nuxtjs/tailwindcss": "^6.14.0", "@pinia/nuxt": "^0.11.3", "@tailwindcss/vite": "^4.1.13", "@vite-pwa/nuxt": "^1.0.4", "@vueuse/motion": "^3.0.3", "bcrypt": "^6.0.0", "date-fns": "^4.1.0", "dexie": "^4.4.2", "exceljs": "^4.4.0", "lucide-vue-next": "^0.556.0", "mongodb": "^6.21.0", "mongoose": "^8.23.1", "nuxt": "^4.2.2", "nuxt-auth-utils": "^0.5.25", "nuxt-charts": "^2.1.4", "nuxt-google-auth": "^0.1.7", "nuxt-notify": "^1.1.4", "nuxt-qrcode": "^0.4.10", "nuxt-vitalizer": "^2.0.0", "openai": "^7.5.0", "oxc-parser": "^0.147.0", "pinia": "^3.0.4", "reka-ui": "^2.6.1", "resend": "^6.12.3", "stripe": "^22.1.1", "tailwindcss": "^4.1.13", "vue": "^3.5.21", "vue-router": "^4.5.1", "xlsx": "^0.18.5", "zod": "^4.4.3" };
      ...
      _push(ssrRenderComponent(_component_UForm, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UFormField, {
              label: "Iced Lead Days",
              name: "cold_lead_after_days"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (isEditing.value) {
                    _push3(ssrRenderComponent(_component_UInput, {
                      modelValue: unref(state).cold_lead_after_days,
                      "onUpdate:modelValue": ($event) => unref(state).cold_lead_after_days = $event,
                      disabled: !isEditing.value,
                      variant: "none",
                      class: "truncate"
                    }, null, _parent3, _scopeId2));
                  } else {
                    _push3(`<span class="block truncate text-sm font-medium text-[#8A847C] max-w-50"${ssrRenderAttr("title", unref(state).cold_lead_after_days.toString())}${_scopeId2}>${ssrInterpolate(unref(state).cold_lead_after_days || "—")}</span>`);
                  }
                } else {
                  return [
                    isEditing.value ? (openBlock(), createBlock(_component_UInput, {
                      ...
                      key: 1,
                      class: "block truncate text-sm font-medium text-[#8A847C] max-w-50",
                      title: unref(state).cold_lead_after_days.toString()
                    }, toDisplayString(unref(state).cold_lead_after_days || "—"), 9, ["title"]))
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=index-AzMM86dW.js.map
