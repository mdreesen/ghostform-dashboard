import { K as useNuxtData, b as useRoute, _ as __nuxt_component_0$1, n as navigateTo, c as __nuxt_component_1$1 } from "../server.mjs";
import { defineComponent, ref, watch, mergeProps, unref, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext, withAsyncContext, computed } from "vue";
...
import { _ as __nuxt_component_0$2 } from "./Base-CmUHGY2S.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(items, (link) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          class: ["relative pb-1 text-[9.5px] uppercase tracking-[0.14em] transition-colors duration-200", isActive(link.to) ? "text-[#1F1B16]" : "text-[#A9A39A] hover:text-[#1F1B16]"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]), { __name: "AppAccess" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_appAccess = __nuxt_component_2;
...
//# sourceMappingURL=authenticated-BTUmSshF.js.map
