import { defineComponent, ref, toRefs, renderSlot, unref, openBlock, createBlock, mergeProps, withCtx, createVNode, computed, watch, withDirectives, vShow, withModifiers, createCommentVNode, normalizeProps, guardReactiveProps, useSSRContext, useSlots, toRef, toHandlers, createTextVNode, toDisplayString, Fragment } from "vue";
import { ssrRenderClass, ssrRenderComponent, ssrRenderSlot, ssrInterpolate } from "vue/server-renderer";
import { e as useVModel, h as createContext, k as useForwardExpose, P as Primitive, M as useEmitAsProps, m as Presence_default, T as Teleport_default, s as useComponentProps, N as useLocale, t as useAppConfig, v as useForwardProps, w as reactivePick, x as usePortal, O as createReusableTemplate, B as tv, V as VisuallyHidden_default, q as _sfc_main$2, F as FieldGroupReset } from "../server.mjs";
import { b as useId, F as FocusScope_default, D as DismissableLayer_default, g as getOpenState, a as useHideOthers, u as useBodyScrollLock } from "./utils-y1felsNN.js";
                                    ...
                                    if (_push5) {
                                      ...
                                      return [
                                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                                          unref(props).close ? (openBlock(), createBlock(_sfc_main$2, mergeProps({
                                            key: 0,
                                            icon: unref(props).closeIcon || unref(appConfig).ui.icons.close,
                                            color: "neutral",
                                            variant: "ghost",
...
//# sourceMappingURL=Modal-BDoaUPlC.js.map
