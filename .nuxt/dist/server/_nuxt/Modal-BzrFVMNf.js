import { defineComponent, ref, toRefs, renderSlot, unref, openBlock, createBlock, mergeProps, withCtx, createVNode, computed, watch, withDirectives, vShow, withModifiers, createCommentVNode, normalizeProps, guardReactiveProps, useSlots, toRef, toHandlers, createTextVNode, toDisplayString, Fragment, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass } from "vue/server-renderer";
import { e as useVModel, h as createContext, k as useForwardExpose, P as Primitive, O as useEmitAsProps, m as Presence_default, T as Teleport_default, s as useComponentProps, R as useLocale, t as useAppConfig, v as useForwardProps, w as reactivePick, x as usePortal, S as createReusableTemplate, B as tv, V as VisuallyHidden_default, q as _sfc_main$1, F as FieldGroupReset } from "../server.mjs";
import { b as useId, F as FocusScope_default, D as DismissableLayer_default, g as getOpenState, a as useHideOthers, u as useBodyScrollLock } from "./utils-CybiXrU-.js";
                      ...
                      if (_push4) {
                        ...
                        return [
                          unref(props).scrollable ? (openBlock(), createBlock(unref(DialogOverlay_default), {
                            ...
                            _: 1
                          }, 8, ["class", "onEnter", "onAfterEnter", "onLeave", "onAfterLeave"])) : (openBlock(), createBlock(Fragment, { key: 1 }, [
...
//# sourceMappingURL=Modal-BzrFVMNf.js.map
