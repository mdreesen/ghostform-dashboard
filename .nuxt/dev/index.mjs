...
import { createHooks as createHooks$1 } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/node_modules/unhead/dist/server.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/public"
      ]
    },
    "http": {
      "domains": []
...
const _pXGsoobNRWP6V83XSG9aS70oHxxE2j4PdrxzpXozrQc = (function(nitro) {
...
const _ynQAtAoQuh2tisu2KMVlgAoDrgbgGiEe7F7CXPJpdY = (nitroApp) => {
...
const plugins = [
  _pXGsoobNRWP6V83XSG9aS70oHxxE2j4PdrxzpXozrQc,
__aY97_Z0V8sXTc6bXyOVcn7rIKxctt5tSWzdqAJeKFg,
_ynQAtAoQuh2tisu2KMVlgAoDrgbgGiEe7F7CXPJpdY,
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"2cd39-UzHabLumZ5E5uEOAfN7wK2QtzAc\"",
    "mtime": "2026-07-02T16:15:48.692Z",
    "size": 183609,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"a2b1e-nDxFFjlY3jlq2MoTeXR8mQF3CfU\"",
    "mtime": "2026-07-02T16:15:48.692Z",
    "size": 666398,
    "path": "index.mjs.map"
  }
...
const getServerEntry = () => import('file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/mdreesen/Documents/Programming/projects/ghostform-dashboard/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _lazy_BUHR7o = () => Promise.resolve().then(function () { return delete_delete$1; });
const _lazy_P6vtRH = () => Promise.resolve().then(function () { return forgot_post$1; });
...
const _lazy_2cEP1i = () => Promise.resolve().then(function () { return index_get$b; });
...
const _lazy_1y4zdH = () => Promise.resolve().then(function () { return cron$1; });
const _lazy_GXmKEA = () => Promise.resolve().then(function () { return create_post$3; });
const _lazy_e1Hz4F = () => Promise.resolve().then(function () { return index_get$9; });
...
const _lazy_fwdmRW = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_GT8Gbh = () => Promise.resolve().then(function () { return index_put$1; });
const _lazy_d19Q7u = () => Promise.resolve().then(function () { return index_get$1; });
...
const handlers = [
  ...
  { route: '/api/homes/create', handler: _lazy_GXmKEA, lazy: true, middleware: false, method: "post" },
  { route: '/api/homes', handler: _lazy_e1Hz4F, lazy: true, middleware: false, method: "get" },
  ...
  { route: '/api/user/rentcast', handler: _lazy_d19Q7u, lazy: true, middleware: false, method: "get" },
...
const forgot_post = defineEventHandler(async (event) => {
  const { email, question } = await readValidatedBody(event, bodySchema$8.parse);
...
const login_post = defineEventHandler(async (event) => {
  var _a;
  const { email, password } = await readValidatedBody(event, bodySchema$7.parse);
  try {
    await connectDB();
...
const reset = defineEventHandler(async (event) => {
  const { password, confirm_password, token } = await readValidatedBody(event, bodySchema$6.parse);
...
const signup_post = defineEventHandler(async (event) => {
  const { company, category, email, password, confirm_password, privacy_policy } = await readValidatedBody(event, bodySchema$5.parse);
  try {
    await connectDB();
...
const test_data = [
  {
    id: "95-Village-Loop-Rd,-Unit-4,-Kalispell,-MT-59901",
    formattedAddress: "95 Village Loop Rd, Unit 4, Kalispell, MT 59901",
    addressLine1: "95 Village Loop Rd",
    addressLine2: "Unit 4",
    city: "Kalispell",
    state: "MT",
    stateFips: "30",
    ...
    lastSeenDate: "2026-07-02T10:37:11.082Z",
    daysOnMarket: 100,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067425",
    listingAgent: {
      name: "Janet Cantrell",
      phone: "4068905390",
      email: "janet.cantrell@exprealty.com",
      website: "www.radiantrealtymt.com"
    },
    listingOffice: {
      name: "IDEAL Real Estate",
      phone: "4068719404",
      email: "hello@ideallife.com",
      website: "http://idealmontana.com"
    },
    history: {
      "2026-03-25": {
        event: "Sale Listing",
  ...
  {
    id: "400-Reserve-Pl,-Kalispell,-MT-59901",
    formattedAddress: "400 Reserve Pl, Kalispell, MT 59901",
    addressLine1: "400 Reserve Pl",
    addressLine2: null,
    city: "Kalispell",
    state: "MT",
    stateFips: "30",
    ...
    countyFips: "029",
    latitude: 48.240105,
    longitude: -114.336134,
    propertyType: "Land",
    lotSize: 107593,
    status: "Active",
    price: 171e3,
    listingType: "Standard",
    listedDate: "2026-03-26T00:00:00.000Z",
    removedDate: null,
    ...
    listingAgent: {
      name: "Brian Schlauch",
      phone: "4064612525",
      email: "brians@purewestmt.com",
      website: "http://www.flatheadluxuryproperty.com"
    },
    listingOffice: { name: "Revel Real Estate", phone: "4067301798" },
    history: {
      "2026-03-26": {
        event: "Sale Listing",
        price: 171e3,
  ...
  {
    id: "917-N-Somers-Rd,-Kalispell,-MT-59901",
    formattedAddress: "917 N Somers Rd, Kalispell, MT 59901",
    addressLine1: "917 N Somers Rd",
    addressLine2: null,
    city: "Kalispell",
    state: "MT",
    stateFips: "30",
    ...
    county: "Flathead",
    countyFips: "029",
    latitude: 48.11752218,
    longitude: -114.1998252,
    propertyType: "Land",
    lotSize: 209524,
    status: "Active",
    price: 345e3,
    ...
    lastSeenDate: "2026-07-02T10:37:11.081Z",
    daysOnMarket: 100,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067445",
    listingAgent: { name: "James Williamson", phone: "4062702121", email: "james@sage-appraisal.com" },
    listingOffice: {
      name: "Silvercreek Realty Group LLC -",
      phone: "4064797770",
      email: "broker@silvercreekrealty.com"
    },
    history: {
      "2026-03-25": {
        event: "Sale Listing",
  ...
  {
    id: "813-Rivet-Way,-Kalispell,-MT-59901",
    formattedAddress: "813 Rivet Way, Kalispell, MT 59901",
    addressLine1: "813 Rivet Way",
    addressLine2: null,
    city: "Kalispell",
    state: "MT",
    stateFips: "30",
    ...
    county: "Flathead",
    countyFips: "029",
    latitude: 48.23403117,
    longitude: -114.3543933,
    ...
    listedDate: "2026-03-26T00:00:00.000Z",
    removedDate: null,
    createdDate: "2025-11-20T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:11.081Z",
    daysOnMarket: 99,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067510",
    listingAgent: { name: "Karly Hanson", email: "karly.hanson@coldwellbanker.com" },
    listingOffice: {
      name: "Coldwell Banker Landstar Properties",
      phone: "4063096636",
      email: "brianna.neater@cbmp.com"
    },
    history: {
      "2025-11-19": {
        event: "Sale Listing",
        price: 145e3,
        listingType: "Standard",
        listedDate: "2025-11-19T00:00:00.000Z",
        removedDate: "2025-12-05T00:00:00.000Z",
        daysOnMarket: 16
      },
      "2026-03-26": {
        event: "Sale Listing",
  ...
  {
    id: "235-Placid-Dr,-Kalispell,-MT-59901",
    formattedAddress: "235 Placid Dr, Kalispell, MT 59901",
    addressLine1: "235 Placid Dr",
    addressLine2: null,
    city: "Kalispell",
    state: "MT",
    stateFips: "30",
    ...
    price: 595e4,
    listingType: "Standard",
    listedDate: "2026-03-31T00:00:00.000Z",
    removedDate: null,
    createdDate: "2026-04-01T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:11.080Z",
    daysOnMarket: 94,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067801",
    listingAgent: { name: "Joy Kendall", phone: "4068802712", email: "joy@bannackre.com" },
    listingOffice: {
      name: "Engel & V\xF6lkers Missoula",
      phone: "4069263322",
      email: "westernfrontier@engelvoelkers.com",
      website: "http://missoula.evrealestate.com"
    },
    history: {
      "2026-03-31": {
        event: "Sale Listing",
  ...
  {
    id: "125-Stoneridge-Dr,-Kalispell,-MT-59901",
    formattedAddress: "125 Stoneridge Dr, Kalispell, MT 59901",
    addressLine1: "125 Stoneridge Dr",
    addressLine2: null,
    city: "Kalispell",
    state: "MT",
    stateFips: "30",
    ...
    price: 899950,
    listingType: "Standard",
    listedDate: "2026-02-12T00:00:00.000Z",
    removedDate: null,
    createdDate: "2021-03-02T13:15:58.831Z",
    lastSeenDate: "2026-07-02T10:37:12.885Z",
    daysOnMarket: 141,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30065108",
    listingAgent: {
      name: "Aaron Noel",
      phone: "4063002725",
      email: "aaron@brodybroker.com",
      website: "http://brodybrokermt.com"
    },
    listingOffice: {
      name: "IDEAL Real Estate",
      phone: "4068719404",
    ...
    history: { "2026-02-12": [Object] }
  },
  {
    id: "905-Wagner-Ln,-Kalispell,-MT-59901",
    formattedAddress: "905 Wagner Ln, Kalispell, MT 59901",
    addressLine1: "905 Wagner Ln",
    addressLine2: null,
    city: "Kalispell",
    state: "MT",
    stateFips: "30",
    ...
    countyFips: "029",
    latitude: 48.163584,
    longitude: -114.200043,
    propertyType: "Land",
    lotSize: 493099,
    status: "Active",
    price: 2379e3,
    listingType: "Standard",
    listedDate: "2026-03-02T00:00:00.000Z",
    removedDate: null,
    createdDate: "2026-03-03T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:12.836Z",
    daysOnMarket: 123,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30065767",
    listingAgent: {
    ...
    history: { "2026-03-02": [Object] }
  },
  {
    id: "95-Village-Loop-Rd,-Unit-1,-Kalispell,-MT-59901",
    formattedAddress: "95 Village Loop Rd, Unit 1, Kalispell, MT 59901",
    addressLine1: "95 Village Loop Rd",
    addressLine2: "Unit 1",
    city: "Kalispell",
    state: "MT",
    ...
    price: 415e3,
    listingType: "New Construction",
    listedDate: "2026-03-23T00:00:00.000Z",
    removedDate: null,
    createdDate: "2026-03-24T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:11.105Z",
    daysOnMarket: 102,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067237",
    listingAgent: {
    ...
    history: { "2026-03-23": [Object] }
  },
  {
    id: "95-Village-Loop-Rd,-Unit-8,-Kalispell,-MT-59901",
    formattedAddress: "95 Village Loop Rd, Unit 8, Kalispell, MT 59901",
    addressLine1: "95 Village Loop Rd",
    addressLine2: "Unit 8",
    city: "Kalispell",
    state: "MT",
    ...
    removedDate: null,
    createdDate: "2026-03-25T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:11.092Z",
    daysOnMarket: 100,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067430",
    listingAgent: {
    ...
    history: { "2026-03-25": [Object] }
  },
  {
    id: "95-Village-Loop-Rd,-Unit-9,-Kalispell,-MT-59901",
    formattedAddress: "95 Village Loop Rd, Unit 9, Kalispell, MT 59901",
    addressLine1: "95 Village Loop Rd",
    addressLine2: "Unit 9",
    city: "Kalispell",
    state: "MT",
    ...
    removedDate: null,
    createdDate: "2026-03-25T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:11.090Z",
    daysOnMarket: 100,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067432",
    listingAgent: {
  ...
  {
    id: "95-Village-Loop-Rd,-Unit-12,-Kalispell,-MT-59901",
    formattedAddress: "95 Village Loop Rd, Unit 12, Kalispell, MT 59901",
    addressLine1: "95 Village Loop Rd",
    ...
    removedDate: null,
    createdDate: "2026-03-25T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:11.088Z",
    daysOnMarket: 100,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067436",
    listingAgent: {
  ...
  {
    id: "95-Village-Loop-Rd,-Unit-5,-Kalispell,-MT-59901",
    formattedAddress: "95 Village Loop Rd, Unit 5, Kalispell, MT 59901",
    addressLine1: "95 Village Loop Rd",
    addressLine2: "Unit 5",
    city: "Kalispell",
    state: "MT",
    ...
    removedDate: null,
    createdDate: "2026-03-25T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:11.086Z",
    daysOnMarket: 100,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067426",
    listingAgent: {
  ...
  {
    id: "95-Village-Loop-Rd,-Unit-3,-Kalispell,-MT-59901",
    formattedAddress: "95 Village Loop Rd, Unit 3, Kalispell, MT 59901",
    addressLine1: "95 Village Loop Rd",
    addressLine2: "Unit 3",
    city: "Kalispell",
    state: "MT",
  ...
  {
    id: "95-Village-Loop-Rd,-Unit-2,-Kalispell,-MT-59901",
    formattedAddress: "95 Village Loop Rd, Unit 2, Kalispell, MT 59901",
    addressLine1: "95 Village Loop Rd",
    addressLine2: "Unit 2",
    city: "Kalispell",
    state: "MT",
    ...
    price: 415e3,
    listingType: "New Construction",
    listedDate: "2026-03-24T00:00:00.000Z",
    removedDate: null,
    createdDate: "2026-03-25T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:11.084Z",
    daysOnMarket: 101,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067395",
    listingAgent: {
    ...
    history: { "2026-03-24": [Object] }
  },
  {
    id: "95-Village-Loop-Rd,-Unit-10,-Kalispell,-MT-59901",
    formattedAddress: "95 Village Loop Rd, Unit 10, Kalispell, MT 59901",
    addressLine1: "95 Village Loop Rd",
    ...
    removedDate: null,
    createdDate: "2026-03-25T00:00:00.000Z",
    lastSeenDate: "2026-07-02T10:37:11.083Z",
    daysOnMarket: 100,
    mlsName: "MontanaRegionalMLS",
    mlsNumber: "30067433",
    listingAgent: {
...
const index_get = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const homes = response.filter((item) => {
      const company_test = "IDEAL Real Estate";
      console.log(item);
      console.log(item.listingOffice.name.toLowerCase().includes(user == null ? void 0 : user.company.toLowerCase()));
