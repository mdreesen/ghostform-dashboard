...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/nuxt-notify/dist/runtime/plugin.js")> &
  InjectionType<typeof import("../../node_modules/nuxt-google-auth/dist/runtime/plugin.client.js")> &
  ...
  InjectionType<typeof import("../../app/plugins/auth-fetch.client")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'vue-devtools-client' | 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'session-fetch-plugin' | 'nuxt:browser-devtools-timing' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | '@nuxt/icon' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'vite-pwa:nuxt:pwa-icons-plugin' | 'nuxt:checkIfLayoutUsed' | 'vite-pwa:nuxt:client:plugin'
  }
}
